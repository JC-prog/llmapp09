# Project Structure
  ...
  # 3. Make sure the backend (llm-multiroute) is running on localhost:8080
  ...
  deepeval test run test_classify.py test_sentiment.py test_summarize.py test_intent.py -n 4
